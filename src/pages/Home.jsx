...
// ... (existing animation variants: floating, cardHover)
    ...
    <div className="min-h-screen bg-[#FFFDF5] text-[#3E2723] font-serif overflow-x-hidden pb-24">
      ...
      <section className="relative h-[90vh] flex items-center justify-center text-center px-6 bg-[#F5F5DC] overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl relative z-10">
          ...
          {/* Hero Headline [cite: 5, 6] */}
          <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight">
            Stop Eating <br /><span className="italic text-[#D4AF37] font-light">"Dead"</span> Flour. [cite: 6]
          </h1>

          {/* Hero Description [cite: 7, 8, 9] */}
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            <Link to="/shop">
              <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="bg-[#3E2723] text-white px-12 py-5 rounded-full text-lg font-bold border-2 border-[#3E2723] transition-all shadow-xl font-sans">
                Claim Founder's Kit
              </motion.button>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center text-left">
            <div className="space-y-10">
              <h2 className="text-4xl md:text-5xl font-bold text-[#3E2723] mb-6 font-serif text-nowrap">The Science of Freshness</h2>
              <div className="space-y-8 font-sans">
                {/* Science Section - Industrial Flour [cite: 10, 11] */}
                <motion.div variants={cardHover} initial="initial" whileHover="hover" className="border-l-4 border-red-200 pl-8 p-6 rounded-r-2xl transition-all cursor-default">
                  <h4 className="text-red-800 font-bold uppercase text-[10px] tracking-[0.2em] mb-2">Industrial Flour [cite: 11]</h4>
                ...
                {/* Science Section - Aarahi Fresh [cite: 12, 13, 14] */}
                <motion.div variants={cardHover} initial="initial" whileHover="hover" className="border-l-4 border-[#D4AF37] pl-8 bg-white py-8 rounded-r-[2rem] shadow-xl border border-transparent cursor-default">
                  <h4 className="text-[#D4AF37] font-bold uppercase text-[10px] tracking-[0.2em] mb-2">Aarahi Fresh [cite: 13]</h4>
                  <p className="text-[#3E2723] font-bold leading-relaxed">
                    Living Nutrition - Stone-milled in small batches at low temperatures to preserve fibre, nutrients, and natural oils. [cite: 13, 14]
                  </p>
                </motion.div>
              </div>
            </div>
            {/* ... existing floating image bag */}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <motion.div whileHover={{ scale: 1.01 }} className="bg-[#F5F5DC] rounded-[3rem] p-12 md:p-20 relative flex flex-col md:flex-row items-center gap-12 border border-[#D4AF37]/20 shadow-sm transition-all">
            <div className="md:w-3/5">
              ...
              {/* Founder Story Headline [cite: 15, 17] */}
              ...
              {/* Founder Story Paragraph [cite: 18, 19] */}
      ...
      <section className="py-24 bg-[#FCF9F2]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          {/* Timeline Section Title [cite: 20, 21] */}
          <h2 className="text-4xl font-bold text-[#3E2723] mb-20 italic font-serif">From Wheat to Your Kitchen in 24 Hours [cite: 21]</h2>
          <div className="relative text-left">
            <div className="absolute left-5 md:left-1/2 h-full w-0.5 bg-[#D4AF37]/30 -translate-x-1/2"></div>
            <div className="space-y-24">
              {[
                /* Timeline Step 1 [cite: 22, 23] */
                { time: "05", title: "The Selection", desc: "We only use premium Sharbati wheat known for soft rotis." }, [cite: 23]
                /* Timeline Step 2 [cite: 24, 25] */
                { time: "09", title: "Cold-Milling", desc: "Stone-milled at a slow pace maintaining low temperature to preserve nutrition." }, [cite: 25]
                /* Timeline Step 3 [cite: 26, 27] */
                { time: "04", title: "Delivery Run", desc: "Freshly milled, packed and delivered across Bengaluru the same day." } [cite: 27]
              ].map((step, index) => (
      ...
      <footer className="bg-[#3E2723] text-white py-20 px-6 text-center">
        ...
        {/* Footer Text [cite: 28, 29] */}
        <p className="font-sans text-gray-400 mb-8 max-w-lg mx-auto">Freshly Milled Atta for Bengaluru Families [cite: 29]</p>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 z-[9999] flex justify-between items-center shadow-[0_-10px_40px_rgba(0,0,0,0.05)] md:hidden">
        ...
        <Link to="/about" className="flex flex-col items-center text-gray-400 hover:text-[#3E2723] transition-all active:scale-95">
          <HelpCircle size={22} />
          {/* Bottom Navigation Label Change [cite: 31] */}
          <span className="text-[9px] font-bold mt-1 uppercase tracking-tighter text-nowrap">Why Aarahi [cite: 31]</span>
        </Link>
        ...
        <Link to="/shop" className="relative bg-[#3E2723] text-[#D4AF37] px-4 py-2 rounded-xl flex flex-col items-center shadow-lg active:scale-95 transition-transform">
          {/* ... existing red dot ping notification */}
