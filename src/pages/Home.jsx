  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] text-[#3E2723] font-serif overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center px-6 overflow-hidden bg-black">
        ...
        <div className="max-w-4xl relative z-10 text-center">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}>
            <button className="bg-[#D4AF37] text-[#3E2723] px-12 py-5 rounded-full text-lg font-bold hover:bg-white transition-all shadow-2xl shadow-[#D4AF37]/20 uppercase tracking-widest text-sm font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          <div className="order-2 md:order-1">
             ...
             <div className="space-y-8 font-sans">
                <div className="bg-white p-8 rounded-3xl shadow-xl border-l-8 border-[#D4AF37]">
                  <h4 className="font-bold text-xl mb-2 uppercase text-xs tracking-widest">Cold-Milling</h4>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border-l-8 border-gray-100">
                  <h4 className="font-bold text-xl mb-2 uppercase text-xs tracking-widest text-gray-400">Freshness</h4>
          ...
          >
            <div className="relative p-4 bg-white rounded-[4rem] shadow-2xl rotate-3">
              ...
              />
              <div className="absolute -bottom-6 -left-6 bg-[#D4AF37] text-white p-6 rounded-3xl font-bold text-center shadow-xl font-sans">
                 <span className="block text-2xl tracking-tighter">100%</span>
                 <span className="text-[10px] uppercase tracking-widest">Sharbati</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#F5F5DC] rounded-[4rem] p-12 md:p-24 flex flex-col md:flex-row items-center gap-16 border border-[#D4AF37]/10">
            <div className="md:w-3/5">
               ...
               <h2 className="text-4xl font-bold mb-8 leading-tight italic text-[#3E2723]">
               ...
               <div>
                  ...
                  <p className="text-[#D4AF37] font-bold uppercase tracking-widest text-sm font-sans">Founder, Aarahi Foods (MBA)</p>
               </div>
            </div>
            ...
            >
              <div className="aspect-square bg-white rounded-full border-[15px] border-white shadow-2xl overflow-hidden flex items-center justify-center italic text-gray-300">
                <span className="text-center p-8">[Aalekhya Reddy Photo]</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 bg-[#FCF9F2] relative overflow-hidden">
        ...
        >
          <img src="/Aarahi-Image.jpg" alt="Grain texture" className="w-full h-full object-cover" />
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="space-y-16 text-left">
             <div className="flex gap-10 items-center">
                <div className="w-16 h-16 rounded-full border-2 border-[#D4AF37] flex items-center justify-center font-bold text-[#D4AF37] text-xl shrink-0 bg-white font-sans">05</div>
                <div>
             ...
             <div className="flex gap-10 items-center">
                <div className="w-16 h-16 rounded-full border-2 border-[#D4AF37] flex items-center justify-center font-bold text-[#D4AF37] text-xl shrink-0 bg-white font-sans">09</div>
                <div>
             ...
             <div className="flex gap-10 items-center">
                <div className="w-16 h-16 rounded-full border-2 border-[#D4AF37] flex items-center justify-center font-bold text-[#D4AF37] text-xl shrink-0 bg-white font-sans">04</div>
                <div>
      ...
      <footer className="bg-[#1A1512] text-white py-24 px-6 text-center">
        ...
        <div className="pt-8 border-t border-white/5 text-[10px] text-gray-600 uppercase tracking-widest font-sans">
          © 2026 Aarahi Foods • MBA-Led Quality Control • Bangalore
        </div>
      </footer>
